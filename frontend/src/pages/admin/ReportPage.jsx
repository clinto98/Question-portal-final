      ...
      <div className="p-6 bg-gray-100 min-h-screen">
        ...
        <div className="flex flex-col md:flex-row justify-center items-center gap-8 mb-6">
          <button
            ...
            className="px-6 py-3 bg-indigo-600 text-white font-semibold rounded-md shadow-md hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 disabled:bg-indigo-400"
            disabled={loading}
          >
                ...
                <tbody className="bg-white divide-y divide-gray-200">
                  {questions.map((q) => (
                    <tr key={q._id}>
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-sm">
                        <span
                          className={`px-2 inline-flex text-xs leading-5 font-semibold rounded-full ${
                            q.statusInReport === "Approved"
                              ? "bg-green-100 text-green-800"
                              : q.statusInReport === "Rejected"
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                        {new Date(q.actionDate).toLocaleString()}
                      </td>
                    </tr>
                  ))}
                </tbody>
