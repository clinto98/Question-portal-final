          ...
          {question.reference.image1 && (
            <div>
              ...
              <img
                ...
                alt="Reference 1"
                className="rounded-lg max-h-48 w-full object-contain border p-2 cursor-pointer" // Adjust size for sidebar
                onClick={() => setFullscreenImage(question.reference.image1)}
              />
            </div>
          )}
          {question.reference.image2 && (
            <div>
              ...
              <img
                ...
                alt="Reference 2"
                className="rounded-lg max-h-48 w-full object-contain border p-2 cursor-pointer" // Adjust size for sidebar
                onClick={() => setFullscreenImage(question.reference.image2)}
              />
            </div>
          )}
        </div>
            ...
            >
              {question.question.image && (
                <img
                  ...
                  onClick={() => setFullscreenImage(question.question.image)}
                />
              )}
                    ...
                    <div className="flex-grow">
                      {opt.image && (
                        <img
                          ...
                          onClick={() => setFullscreenImage(opt.image)}
                        />
                      )}
                      <p>{opt.text}</p>
                    </div>
              ...
              >
                {question.explanation.image && (
                  <img
                    ...
                    className="rounded-lg max-h-80 w-auto mb-4 border p-2 cursor-pointer"
                    onClick={() =>
                      setFullscreenImage(question.explanation.image)
                    }
                  />
                )}
