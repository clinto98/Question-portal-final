...
// Left side branding component (Consistent with LoginPage)
const Branding = () => (
  <div 
...
export default function AdminLogin() {
  ...
  const primaryColor = "purple"; // Admin theme color
  ...
  const handleLogin = async () => {
    ...
    navigate("/admin"); // Corrected redirect to /admin
  };
    ...
    <div className="flex min-h-screen font-sans">
      ...
      <div className="w-full lg:w-1/2 flex justify-center items-center bg-gray-100 p-8 sm:p-12">
        <div className="w-full max-w-md">
          <h2 className="text-3xl font-bold text-gray-800 mb-4">Admin Sign In</h2>
          <p className="text-gray-600 mb-8">Use your administrative credentials to log in.</p>
            ...
            <form onSubmit={(e) => { e.preventDefault(); handleLogin(); }} className="flex flex-col gap-6">
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full pl-12 pr-4 py-3 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-purple-500 transition`}
                />
              </div>
              <div className="relative">
              ...
              <button
                type="submit"
                className={`w-full py-3 mt-4 rounded-lg bg-purple-600 text-white font-bold shadow-lg hover:bg-purple-700 transform hover:scale-105 transition-all duration-300`}
              >
                Sign In as Admin
              </button>
